...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="rounded-3xl border border-slate-200 bg-white shadow-[0_25px_45px_-35px_rgba(15,23,42,0.3)]">
        ...
        <form method="GET" class="flex flex-col gap-3 border-b border-slate-200/70 px-6 py-5 md:grid md:grid-cols-[minmax(0,1fr)_auto_auto_auto_auto]">
                <div class="relative">
            ...
            <select name="tingkatan" class="h-11 rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-600 focus:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100">

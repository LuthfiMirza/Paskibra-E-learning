...
<head>
    ...
    <title>Dashboard PASKIBRA E-Learning</title>
        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <div class="mb-6">
                    ...
                    <!-- Dashboard - Active -->
                    <a href="#" class="flex items-center px-3 py-2 rounded-lg bg-blue-600 text-white">
        ...
        <div class="p-6">
            ...
            <section class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Mulai Belajar Card -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
